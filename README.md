...
- 👉 [Complete documentation](https://docs.appseed.us/products/flask-dashboards/datta-able) - `Learn how to use and update the product`
  - ✅ [Set up the environment](https://docs.appseed.us/products/flask-dashboards/datta-able#environment)
  - ✅ [Manage App users](https://docs.appseed.us/products/flask-dashboards/datta-able#manage-app-users)
  - ✅ [Application Bootstrap Flow](https://docs.appseed.us/products/flask-dashboards/datta-able#application-bootstrap-flow)
  - ✅ [UI Assets and Templates](https://docs.appseed.us/products/flask-dashboards/datta-able#ui-assets-and-templates)
  - ✅ [Set up the MySql Database](https://docs.appseed.us/products/flask-dashboards/datta-able#set-up-the-mysql-database)
  - ✅ [Static Assets for production](https://docs.appseed.us/products/flask-dashboards/datta-able#static-assets-for-production)  

<br />

> Built with [Datta Able Generator](https://appseed.us/generator/datta-able/)

- Timestamp: `2022-06-07 23:18`
- Build ID: `5e2a4672-e6fb-496e-9f6a-599a0a2db3d0`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5e2a4672-e6fb-496e-9f6a-599a0a2db3d0.git
$ cd 5e2a4672-e6fb-496e-9f6a-599a0a2db3d0
```
